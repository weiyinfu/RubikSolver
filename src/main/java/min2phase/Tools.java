...
public class Tools {
     ...
     *
     * @see min2phase.Tools#saveTo(java.io.DataOutput)
     */
     ...
     *
     * @see min2phase.Tools#initFrom(java.io.DataInput)
     */
     ...
     *
     * The random source can be set by {@link min2phase.Tools#setRandomSource(java.util.Random)}
     *
     ...
     *
     * @see min2phase.Tools#setRandomSource(java.util.Random)
     * @see min2phase.Search#solution(java.lang.String facelets, int maxDepth, long timeOut, long timeMin, int verbose)
     */
     ...
     *
     * @param facelets is the cube definition string , see {@link min2phase.Search#solution(java.lang.String facelets, int maxDepth, long timeOut, long timeMin, int verbose)}
